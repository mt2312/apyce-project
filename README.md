...
G = Model(fn='./Data/UNISIM_II_D_ECLIPSE.DATA', grid_origin='Eclipse', verbose=True)
G.process_grdecl()
G.write_vtu()
G.plot_grid(filename='./Data/Results/UNISIM_II_D_ECLIPSE.vtu', lighting=True, property='PORO', show_edges=True,
...
<p align="center">
  <img src = "./img/output_getting_started.png.png" width="100%">
</p>
